...
Myanmar Township Boundary Data Shan-ICT.csv
...
Elbow Method Average Silhouette Method Gap Statistic Method \### 5.7.9.1 Gap Statistic Method To compute the gap statistic, clusGap() of cluster package will be used.
...
With heatmaply, we are able to build both highly interactive cluster heatmap or static cluster heatmap. \### 5.7.11.1 Transforming the data frame into a matrix The code chunk below will be used to transform shan_ict data frame into a data matrix.
